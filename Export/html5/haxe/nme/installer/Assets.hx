...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/ProFontX.ttf", NME_assets_profontx_ttf);
			resourceNames.set ("assets/ProFontX.ttf", "assets/ProFontX.ttf");
			resourceTypes.set ("assets/ProFontX.ttf", "font");
