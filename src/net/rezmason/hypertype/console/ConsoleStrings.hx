...
class ConsoleStrings {
    ...
    public inline static var CARET_STYLE:String = '§{name:_c1,w:0.4}§{name:_c2,w:0}∂{name:caret,period:1,frames:[_c1,_c2],s:1.5,a:0.5,ease:Quart_easeOut}';
    ...
    public inline static var BREATHING_PROMPT_STYLE:String = '§{name:_br1,w:0}§{name:_br2,w:0.2}∂{name:breathingprompt,period:3.5,frames:[_br1,_br2], s:1.7, persist:true}';
    public inline static var BREATHING_PROMPT_STYLENAME:String = 'breathingprompt';

    public inline static var ACTION_HINT_STYLE:String = '§{name:__action_hint, r:0.8, g:0.8, b:0.8, w:-0.1}';
    ...
    public inline static var ERROR_STYLES:String =
        ...
        '§{name:__errorOutput, g:0, b:0, w:0.2, a:1}';
