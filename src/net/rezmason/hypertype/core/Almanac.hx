...
class Almanac {
    ...
    public inline static var W_OFFSET:Int = 2;
    ...
    public inline static var HITBOX_R_OFFSET:Int = 0;
    public inline static var HITBOX_G_OFFSET:Int = 1;
    public inline static var HITBOX_H_OFFSET:Int = 2;
    public inline static var HITBOX_S_OFFSET:Int = 3;
    ...
    public inline static var FONT_FLOATS_PER_VERTEX:Int = W_OFFSET + 1;
    public inline static var GEOMETRY_FLOATS_PER_VERTEX:Int = P_OFFSET + 1;
    public inline static var HITBOX_FLOATS_PER_VERTEX:Int = HITBOX_S_OFFSET + 1;
    ...
    public inline static var HITBOX_FLOATS_PER_GLYPH:Int = HITBOX_FLOATS_PER_VERTEX * VERTICES_PER_GLYPH;
