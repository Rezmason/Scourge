...
class DropPieceRulePresenter extends RulePresenter {
    override function animateGlyphs() {
        ...
        populateGlyphs(slam.topTo, slam.bottomTo, nodeState.values);
        ...
        populateGlyphs(cool.topTo, cool.bottomTo, nodeState.values);
        cool.bottomTo.set_pos(nodeState.petriData.pos);
        cool.topTo.set_pos(nodeState.petriData.pos);
