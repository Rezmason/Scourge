...
class KTUtil {
	 ...
	 */
	public static function resetBevelFilter():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetBlurFilter():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetDropShadowFilter():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetGlowFilter():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetMatrix():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetColorTransform():Dynamic {
	 ...
	 * @return	A reset object.
	 */
	public static function resetPoint():Dynamic {
		return {x: 0.0, y: 0.0};
	}
	 ...
	 * @return	A reset object.
	 */
	public static function resetRectangle():Dynamic {
